...
class MockedSession(BaseSession):
    def __init__(self):
        ...
        self.response: Deque[Response[TelegramType]] = deque()
        self.request: Deque[TelegramMethod[TelegramType]] = deque()
        self.closed = True
    ...
    async def make_request(
        ...
        self.closed = False
        self.request.append(method)
        response: Response[TelegramType] = self.response.popleft()
        self.check_response(
            bot=bot,
            method=method,
